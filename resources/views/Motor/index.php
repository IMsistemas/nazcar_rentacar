...
<div class="container" style="margin-top: 10px;" ng-controller="motorController" ng-init="initLoad(1)">
	
	<div class="col-xs-12">
		<h4>Registro de Tipos de Motores</h4>
		<hr>
	</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" name="formMotor" novalidate="">
                        <div class="row">
                            <div class="col-12">
                                <div class="input-group">
                                    <span class="input-group-addon">Tipo Motor: </span>
                                    <input type="text" class="form-control" id="namemotor" name="namemotor" ng-model="namemotor" required />
                                </div>
                                <span class="help-block error" ng-show="formMotor.namemotor.$invalid && formMotor.namemotor.$touched">
                                    <small id="emailHelp" class="form-text text-danger text-right">El Tipo Motor es requerido</small>
                                </span>
                            </div>
                        </div>
                    </form>
